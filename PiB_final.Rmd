...
rawdata_url <- ("https://github.com/nakulrrraval/Protien_depo_pig_model_PIB/blob/PET/alldat_raw.RDS")
download.file(rawdata_url, "alldat_raw.RDS", method = "curl")
alldat <- readRDS("alldat_raw.RDS")
```
